...
$sqlPubli="SELECT DET_PUB FROM detalle_publicacion WHERE ID_DET_PUB=$publiRes";
    ...
    <div class="container-fluid" style="padding-top: 100px;">
        <div class="row">
            ...
            <div class="col-10">
                ...
                <?php if($row) { ?>
                <div class="mb-4">
                    <form <?php echo 'action="crudPublicaciones.php?action=ur&publiresp='.$publiRes.'&publi='.$publi.'"' ?>  method="POST" enctype="multipart/form-data">
                        <div class="form-floating mb-3">
                            <textarea class="form-control" name="detpub" placeholder="Leave a comment here"
                                id="floatingTextarea2" style="height: 100px"
                                required><?php echo $row['DET_PUB']?></textarea>
