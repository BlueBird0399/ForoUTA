...
$searchInscrito="SELECT CED_USU_PER,ID_CUR_PER as TOTAL FROM detalle_curso WHERE ID_CUR_PER=$curso and CED_USU_PER=$sesssion";
    ...
    <div class="container-fluid" style="padding-top: 100px;">
        <div class="row">
            ...
            <?php if(mysqli_num_rows($busquedaI)>0) {?>
                     <h3 style="text-align:center;">Ya esta Inscrito en este Curso</h3>  
                ...
                <table id="table" class="table">
                    ...
                    <form class="form-curso" action="crudCurso.php" method="POST">
                    <input style="margin-left:550%" style="width: 200px;" type="submit" class="exit-enter-course" value="Salir del Curso">
                    </form >
                    <?php } else {?>
                    <form class="form-curso" action="crudCurso.php" method="POST">
                    <input style="margin-left:550%" type="submit" class="exit-enter-course" value="Inscibirse">
                    </form >
                    <form class="form-curso" action="crudCurso.php" method="POST">
                    <input style="margin-left:600%"  type="submit" class="exit-enter-course" value="Enviar">
                    </form>
                    <?php } ?> 
